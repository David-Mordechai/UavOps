...
/// Lives in this project (moved from <c>UavOps.Agent</c> as part of the MCP domain split) since
/// Moav operations now execute in their own process, reached via <see cref="MoavTools"/>.
/// </summary>
