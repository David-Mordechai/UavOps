...
/// <summary>The mechanical contract for one operation, reflected from an operation interface
/// (e.g. <c>IOperationService</c>, <c>ISimulatorService</c>) by <see cref="OperationCatalog"/>.</summary>
