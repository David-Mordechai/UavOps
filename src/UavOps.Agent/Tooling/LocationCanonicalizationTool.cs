...
/// <summary>
/// Wraps a fleet-operation <see cref="AIFunction"/> (a remote fleet-server <c>McpClientTool</c>,
/// wrapped generically - this class only ever calls <c>_inner.InvokeAsync</c>) for any operation
/// with a "location" argument (Navigate, PointPayload) to deterministically canonicalize it - via
