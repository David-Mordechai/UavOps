...
/// they're domain data, not infrastructure, and <see cref="Hubs.IOperationClientProxy"/>'s
/// matching method names are additionally pinned by the (unchanged) net47 client's wire contract.
/// </summary>
